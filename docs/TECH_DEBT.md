...
- **[Fase 7] Automatizar o e2e via docker-compose:** a suite e2e (pacote e2e/, Bloco 9) roda contra o stack local subido manualmente (4 servicos npm run dev + infra). Containerizar os servicos e orquestrar no compose permitiria rodar o e2e no CI. Anda junto com a containerizacao dos servicos.
